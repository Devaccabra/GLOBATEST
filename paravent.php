...
do{
    $continent = readline("Largeur du continent (comprise entre 1 et 100 000) : ");
...
do{
    $str_altitutes = readline("Entrer les ".$continent." valeurs séparées d'un espace (entre 0 et 100 000 : ");
    $altitudes = explode(" ", $str_altitutes);
}while(count($altitudes) != $continent);
